...
class TestPaperPodcastAppAudioRecovery:
    ...
    def test_monitor_audio_generation_progress_completed(self):
        """Test monitoring progress when generation is completed."""
    ...
    def test_monitor_audio_generation_progress_active(self):
        """Test monitoring progress when generation is active."""
        # Set up active state
        self.user_session.update_audio_generation_state(
            is_generating=True,
            status="generating",
